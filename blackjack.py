...
class Player(object):
    def __init__(self, name, startingCash):
        ...
        self.name = name
        self.hand = []
        # what is current_bet for? you initialize it and never use it
        current_bet = None
    #def __str__():
    ...
    def hit(self, deck):
        # new_card really doesn't need to be assigned if you don't call on the variable
...
def play_hand(player, dealer):
    ...
    # dealer_hand is never used. perhaps just call dealer.action()?
    dealer.show_hand()
...
def help():
    print(
        'You can type help at any time to access this information.\n'
